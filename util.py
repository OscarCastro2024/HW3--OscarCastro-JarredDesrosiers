...
def connect_to_db(username='oscar',password='test',host='127.0.0.1',port='5432',database='dvdrental'):
  try:
    ...
    #Create a cursor to perfrom database operations 
